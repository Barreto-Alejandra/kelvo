  ...
  },
  {
    ...
    content: {
      en: {
        ...
        description:
          'Create QR codes from any text, link or Wi-Fi instantly. Customize colors and size, download as PNG or SVG. Free, no watermark, runs in your browser.',
        h1: 'QR Code Generator',
        intro:
          'Turn any link or text into a QR code instantly. Customize the colors and size, then download it as a PNG or scalable SVG. No watermark, no signup — generated right in your browser.',
        keywords:
          'qr code generator, create qr code, qr code maker, free qr code, qr png svg',
        faq: [
          {
            q: 'Do these QR codes expire?',
            a: 'No. These are static QR codes that encode your content directly, so they never expire and keep working forever.',
          },
          {
            q: 'Is there a watermark or limit?',
            a: 'No watermark and no limits. Generate as many QR codes as you want, completely free.',
          },
          {
            q: 'PNG or SVG — which should I download?',
            a: 'Use PNG for quick sharing and SVG when you need to print large or resize without losing quality.',
          },
        ],
        ui: {
          ...
          empty: 'Type something above to create your QR code.',
        },
      },
      es: {
        slug: 'generador-de-codigos-qr',
        name: 'Generador de QR',
        title: 'Generador de Códigos QR — Gratis y Sin Marca',
        description:
          'Creá códigos QR de cualquier texto o enlace al instante. Personalizá colores y tamaño, descargá en PNG o SVG. Gratis, sin marca de agua, en tu navegador.',
        h1: 'Generador de códigos QR',
        intro:
          'Convertí cualquier enlace o texto en un código QR al instante. Personalizá los colores y el tamaño, y descargalo como PNG o SVG escalable. Sin marca de agua ni registro: se genera en tu navegador.',
        keywords:
          'generador de códigos qr, crear código qr, generar qr, código qr gratis, qr png svg',
        faq: [
          {
            q: '¿Estos códigos QR caducan?',
            a: 'No. Son códigos QR estáticos que codifican tu contenido directamente, así que nunca caducan y funcionan para siempre.',
          },
          {
            q: '¿Tienen marca de agua o límite?',
            a: 'Sin marca de agua y sin límites. Generá todos los códigos QR que quieras, totalmente gratis.',
          },
          {
            q: '¿PNG o SVG, cuál descargo?',
            a: 'Usá PNG para compartir rápido y SVG cuando necesites imprimir en grande o redimensionar sin perder calidad.',
          },
        ],
        ui: {
          ...
          empty: 'Escribí algo arriba para crear tu código QR.',
        },
      },
    },
  },
